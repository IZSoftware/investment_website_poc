...
// ─── Responsive Orbit ────────────────────────────────────────────────────────
// On mobile the orbit collapses into a scrollable legend list.
// On ≥768 px it shows the animated SVG orbit.
function AssetOrbit() {
  ...
  return (
    <>
      <style>{`
        ...
        /* Mobile: hide orbit, show card list */
        .orbit-desktop { display: none; }
        .orbit-mobile  { display: flex; flex-direction: column; gap: 10px; width: 100%; }

        @media (min-width: 700px) {
          .orbit-desktop { display: flex; flex-direction: column; align-items: center; }
        ...
        .leg-nm  { font-size: 12.5px; font-weight: 600; color: #000; }
        .leg-vl  { font-size: 11px; color: #666; margin-top: 2px; }
      `}</style>
        ...
        <div style={{ overflowX: "auto", overflowY: "hidden", maxWidth: "100%" }}>
          <div className="orbit-scene">
            ...
            <div style={{
              ...
              <span style={{ fontSize: 9, fontWeight: 600, letterSpacing: ".12em", textTransform: "uppercase", color: "#777", marginBottom: 4 }}>
                {activeAsset ? "SELECTED" : "TOTAL AUM"}
              </span>
              <span style={{ fontSize: activeAsset ? 16 : 20, fontWeight: 700, color: "#000", lineHeight: 1, transition: "font-size .2s", textAlign: "center" }}>
                {activeAsset ? activeAsset.pct : TOTAL_AUM}
              </span>
              <span style={{ fontSize: 9, color: "#777", marginTop: 4, textAlign: "center", lineHeight: 1.4 }}>
    ...
    <div style={{ fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", background: "#f8f8f8", minHeight: "100vh", color: "#000" }}>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (min-width: 640px) {
          .stat-cell { padding: 26px 22px; border-bottom: none; }
          .stat-cell:nth-child(2) { border-right: 1px solid #e0e0e0; }
        }
        ...
        .tl-ev  { font-size: 13.5px; color: #333; line-height: 1.6; }
        ...
        .val-body { font-size: clamp(12px, 1.3vw, 13.5px); color: #555; line-height: 1.65; }
      `}</style>
        ...
        <div className="pg" style={{ position: "relative", zIndex: 1, height: "100%" }}>
          <div className="col" style={{ display: "flex", alignItems: "center", height: "100%" }}>
            <div style={{ padding: "0", maxWidth: 640 }}>
              ...
              <h1 style={{ fontSize: "clamp(26px, 5.5vw, 72px)", fontWeight: 700, color: "#fff", lineHeight: 1.05, marginBottom: 14, marginTop: 8 }}>
                {hero.headline}
              </h1>
              <p style={{ fontSize: "clamp(13px, 1.6vw, 17px)", color: "rgba(255,255,255,0.88)", lineHeight: 1.7, maxWidth: 500 }}>
                {hero.subheadline}
              </p>
      ...
      <div className="pg"><div className="col"><div className="sec">
        <div className="two-col">
          <div>
            ...
            <p style={{ fontSize: "clamp(13px, 1.5vw, 16px)", color: "#333", lineHeight: 1.75, marginBottom: 16 }}>
              {whoWeAre.para1}
            </p>
            <p style={{ fontSize: "clamp(13px, 1.5vw, 16px)", color: "#333", lineHeight: 1.75 }}>
              {whoWeAre.para2}
            </p>
          </div>
          <div>
      ...
      <div className="pg"><div className="col"><div className="sec">
        <div style={{ marginBottom: "clamp(20px, 3.5vw, 40px)" }}>
          ...
          <p style={{ fontSize: "clamp(12px, 1.5vw, 15px)", color: "#333", lineHeight: 1.7, maxWidth: 500, marginTop: 8 }}>
            ...
            return (
              <div key={asset.id} className="acc-card">
                <button className="acc-hd" onClick={() => setExpanded(isOpen ? null : asset.id)}>
                  ...
                  {subs.length > 0 && (
                    <span className="acc-chev" style={{ transform: isOpen ? "rotate(180deg)" : "rotate(0deg)" }}>▼</span>
                  )}
                </button>
                    ...
                    {subs.map((s, i) => (
                      <div key={i} className="acc-sub">
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: "clamp(11px, 1.2vw, 12.5px)", color: "#666" }}>{s.desc}</div>
                        </div>
